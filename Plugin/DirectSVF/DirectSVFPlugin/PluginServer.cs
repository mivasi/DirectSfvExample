...
{
    [Guid("9641ff40-1e73-4208-be7a-4936197d4743")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": DirectSVFPlugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");
        ...
        {
            Trace.TraceInformation(": DirectSVFPlugin: deactivating... ");
